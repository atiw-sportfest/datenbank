...
INSERT IGNORE INTO typ (typ_id,typ_name,typ_descr,typ_typ,typ_conv) VALUES (@t_int, "Ganzzahl", "Einfacher Zahlewert","java.lang.Integer","parseInt"), (@t_str, "Zeichenkette", "Zeichenkette","java.lang.String",null), (@t_stz, "Sternzeichen", "Ein Sternzeichen","String", null), (@t_flt, "Fließkommazahl", "Kommazahl", "java.lang.Float", "parseFloat");
...
INSERT IGNORE INTO variable (var_id,var_name,var_descr,var_exprParam,typ_id) VALUES (2000,"Weite", "Weite in cm", "weite", @t_flt), (2001,"Sternzeichen", "Das Sternzeichen des Teilnehmers", "stz", @t_stz);
